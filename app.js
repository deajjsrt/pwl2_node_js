...
// Set EJS untuk view sebagai HTML
app.set('views', path.join(__dirname, 'views'));
app.engine('html', ejs.renderFile); // Set view engine sebagai HTML
app.set('view engine', 'html');

// Route ke halaman utama
app.get('/', (req, res) => {
    res.render('index');  // Pastikan file views/index.html atau views/index.ejs ada
});
